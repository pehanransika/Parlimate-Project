            ...
            <div class="items col">
                ...
                <c:forEach var="ongoinmeetings" items="${ongoingMeetings}">
                    <div class="item live row"
                         ...
                         data-meetingid="${ongoinmeetings.meetingId}"
                         data-topic="${ongoinmeetings.topic}"
                         data-date="${ongoinmeetings.date}"
                         data-description="${ongoinmeetings.description}"
                         data-time="${ongoinmeetings.time}">
                        <div class="panelists">
                            <div class="pImgs row">
                                <div class="prof-img">
                        ...
                        <div class="item-content live col">
                            ...
                            <div class="item-interactive row">
                                ...
                                <div class="body" style="color: #ea2f07">Registration Deadline - ${ongoinmeetings.deadlinetoregister}</div>
                            </div>
                        </div>
                        <div class="post-options col">
                            <div class="status capitalize row">
                                <span>${ongoinmeetings.politicianId}</span>
                            </div>
                        </div>
                    </div>
                </c:forEach>
...
<script src="${pageContext.request.contextPath}/DiscussionRoom/reqPop.js"></script>
<script>
