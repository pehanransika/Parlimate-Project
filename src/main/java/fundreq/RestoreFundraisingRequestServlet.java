...
@WebServlet("/RestoreFundraisingRequestServlet")
public class RestoreFundraisingRequestServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // Attempt deletion
            boolean isAdded = RequestController.restorerequest(requestId);
