...
@WebServlet("/HoldApprovedRequestServlet")
public class HoldApprovedRequestServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // Attempt deletion
            boolean isHold = ApproveController.holdApprovedRequest(requestId);
            ...
            if (isHold) {
                ...
                response.setContentType("text/html");
                response.getWriter().println("<script>alert('Request not found or already Hold.'); window.location.href='error.jsp';</script>");
            }
