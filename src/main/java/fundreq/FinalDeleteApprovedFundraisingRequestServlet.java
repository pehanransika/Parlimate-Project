...
@WebServlet("/FinalDeleteApprovedFundraisingRequestServlet")
public class FinalDeleteApprovedFundraisingRequestServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // Attempt deletion
            boolean isDeleted =ApproveController.deleteApprovedRequest(requestId);
