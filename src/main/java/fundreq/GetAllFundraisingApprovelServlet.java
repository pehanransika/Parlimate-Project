...
@WebServlet("/GetAllFundraisingApprovelServlet")
public class GetAllFundraisingApprovelServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("fundraising.jsp");
