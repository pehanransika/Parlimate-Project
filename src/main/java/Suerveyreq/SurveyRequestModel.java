package Suerveyreq;  // Consider renaming the package to 'Surveyreq'

import java.sql.Timestamp;
import java.time.LocalDateTime;

public class SurveyRequestModel {  // Renamed class to correct typo
    ...
    // Constructor
    public SurveyRequestModel(Integer surveyRequestId, Integer userId, String questionText,
                              String answer01, String answer02, String answer03, String answer04,
